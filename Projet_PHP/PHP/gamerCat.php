...
<body>
    ...
    <!-- PAGE -->
    <div class="row">
        <?php $products = $DB->query('SELECT * FROM products WHERE cat_product = "pcGamer"');
        foreach ($products as $product) : ?>
            <div class="col">
                <a href="item.php?id_product=<?php echo $product->id_product ?>">
                ...
                <div class="div-btn">
                    ...
                    <a href="addBag.php?id_product=<?php echo $product->id_product ?>"><button class="btn btn-buy" id="change-btnA1"><i class="fa-solid fa-cart-plus"></i></button></a>
                </div>
            </div>
        <?php endforeach ?>
    </div>
