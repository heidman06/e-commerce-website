...
<body>
    ...
    <div class="container">
        ...
        <?php $products = $DB->query('SELECT * FROM products ORDER BY cat_product, id_product');
                ...
                <div class="div-item">
                    ...
                    <div class="div-desc">
                        <div class="div-name-available">
                            ...
                            <div class="available">X avaible now</div>
                            <!-- A VOIR SI ON RAJOUTE CA !!! -->
                            <!-- <div class="add-quantity"><button class="btn-add-quantity">add 10 item in stock</button><span>(reload to update the stock)</span></div> -->
                        </div>
                        <div class="div-edit-remove">
                            ...
                            <a class="a-trash-can" href="delItemProcess.php?id_product=<?php echo $product->id_product ?>">
